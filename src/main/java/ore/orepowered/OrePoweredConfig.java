...
import ore.orepowered.command.defaultcomamnd.Commandorepowered;
import ore.orepowered.command.defaultcomamnd.VersionCommand;
...
public class OrePoweredConfig {
    ...
    private static final String HEADER = "This is the main configuration file for OrePowered.\n"
    ...
    public static void init(File configFile) {
        ...
        try {
            ...
            OrePowered.LOGGER.error("Could not load orepowered.yml, please correct your syntax errors", ex);
        ...
        commands.put("orepowered", new Commandorepowered("orepowered"));
    ...
    public static void registerCommands() {
        for (Map.Entry<String, Command> entry : commands.entrySet()) {
            MinecraftServer.getServerInst().server.getCommandMap().register(entry.getKey(), "OrePowered", entry.getValue());
        }
        new Metrics();
    }
