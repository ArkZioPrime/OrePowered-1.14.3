package ore.orepowered.command.defaultcomamnd;
...
import ore.orepowered.OrePoweredConfig;

import java.util.Collections;
import java.util.List;
import java.util.Locale;

public class Commandorepowered extends Command {

    public Commandorepowered(String name) {
        super(name);
        this.description = "OrePowered related commands";
        this.usageMessage = "/orepowered [potions|enchants|materials]";
        this.setPermission("bukkit.command.orepowered");
    }
