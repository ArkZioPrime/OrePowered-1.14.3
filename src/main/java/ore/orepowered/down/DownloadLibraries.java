...
public class DownloadLibraries implements Runnable {
    @Override
    public void run() {
        String url = "https://github.com/orepowered/OrePowered/releases/download/libraries/libraries.zip";
        ...
        if (locale.getCountry().equals("zh_CN") || locale.getCountry().equals("CN") || locale.getCountry().equals("zh_TW") || locale.getCountry().equals("TW")) {
            url = "https://github.com/orepowered/OrePowered/releases/download/libraries/libraries.zip";
        }
