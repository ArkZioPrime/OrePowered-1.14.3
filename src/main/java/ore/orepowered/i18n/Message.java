package ore.orepowered.i18n;

import java.text.MessageFormat;
import java.util.ResourceBundle;

public enum Message {
    OrePowered_Test("orepowered.test"),
    OrePowered_Start("orepowered.start"),
    OrePowered_Server_Start("orepowered.server.start"),
    OrePowered_Start_Error("orepowered.start.error"),
    Not_Have_Library("orepowered.start.error.nothavelibrary"),
    ...
    OrePowered_Load_Map("orepowered.load.map"),
    OrePowered_Load_Map_Spawn("orepowered.load.map.spawn"),
    OrePowered_Stop("orepowered.stop"),
    OrePowered_Start_Fail("orepowered.start.fail"),
    OrePowered_Save_Players("orepowered.save.players"),
    OrePowered_Save_Worlds("orepowered.save.worlds"),
    OrePowered_Save_Other("orepowered.save.other"),
    ...
    orepowered_bytes("orepowered.bytes"),
	...
	OrePowered_update_program("orepowered.update.program"),
	OrePowered_update_program_check_hasupdate("orepowered.update.program.check.hasupdate"),
	OrePowered_update_program_check_noupdate("orepowered.update.program.check.noupdate"),
	OrePowered_update_program_tips_stopautoget("orepowered.update.program.tips.stopautoget"),
	OrePowered_update_message("orepowered.update.message"),
	OrePowered_update_date("orepowered.update.date"),
	OrePowered_update_program_tips_done("orepowered.update.program.tips.done"),
	OrePowered_update_program_tips_false("orepowered.update.program.tips.false"),
    ...
    public static ResourceBundle rb = ResourceBundle.getBundle("assets.orepowered.lang.message", new UTF8Control());
    //public static ResourceBundle rb = OrePowered.rb;
